...
**Story:** P3-003 - Build denied party search UI
...
3. Run: npm run build
4. If build passes, update prd.json to set passes: true for story P3-003
5. Append learnings to progress.txt with format:
   ### Story P3-003 - 2026-01-19
   **What I Did:** [summary]
   **Patterns Found:** [patterns]
   **Gotchas:** [gotchas]
   **For Next Time:** [advice]
6. Commit: git add -A && git commit -m "feat(P3-003): [description]"
