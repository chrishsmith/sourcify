...
**Story:** P2-003 - Save and compare scenarios
...
3. Run: npm run build
4. If build passes, update prd.json to set passes: true for story P2-003
5. Append learnings to progress.txt with format:
   ### Story P2-003 - 2026-01-19
   **What I Did:** [summary]
   **Patterns Found:** [patterns]
   **Gotchas:** [gotchas]
   **For Next Time:** [advice]
6. Commit: git add -A && git commit -m "feat(P2-003): [description]"
